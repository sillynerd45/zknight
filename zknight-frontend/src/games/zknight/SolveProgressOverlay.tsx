...
function StepIcon({status}: { status: StepStatus }) {
    ...
    if (status === 'active') return <div className={styles.solveStepIconActive}>
        <div className={styles.solveStepSpinner}/>
    </div>;
...
function labelClass(status: StepStatus): string {
    switch (status) {
        case 'pending':
            return styles.solveStepLabelPending;
        case 'active':
            return styles.solveStepLabelActive;
        case 'done':
            return styles.solveStepLabelDone;
        case 'error':
            return styles.solveStepLabelError;
    }
}
                                ...
                                <div className={styles.solveStepBody}>
                                    ...
                                    {steps.commit === 'error' && error && (
                                        <>
                                            ...
                                            <button className={styles.btnDanger} style={{marginTop: '0.5rem'}}
                                ...
                                <div className={styles.solveStepBody}>
                                    ...
                                    {steps.prove === 'active' && (
                                        <p className={styles.solveStepDetail}>
                                            {proofProgress || 'Preparing circuit...'}&nbsp;— This may take 15–25 seconds
                                        </p>
                                    )}
